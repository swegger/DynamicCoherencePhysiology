            ...
            if initOnly
                if resultsFile(subjecti)
                    ...
                    neuronTypingAnalysis_initCoh('dcpObjectFile','dcpObjects20210406',...
                        ...
                        'initCohPertFile','/home/seth/Projects/DynamicCoherencePhysiology/ar/initCohPertResults/initCohPert20240208.mat',...
                        'saveFigures',saveFigures,...
                        'saveResults',saveResults);
                end
            else
...
%                         'saveResults',false);
        ...
        case 'fr'
            if initOnly
                if resultsFile(subjecti)
                    neuronTypingAnalysis_initCoh('resultsFile','/home/seth/Projects/DynamicCoherencePhysiology/fr/initCohDynCohComp/neuronTyping_initCoh20240208.mat',...
                        'saveFigures',saveFigures,...
                        'saveResults',saveResults);                    
                else
...
%                         'saveResults',false);
                    ...
                    neuronTypingAnalysis('dcpObjectFile','dcpObjects20230322',...
                        'sourceDirectory','/mnt/Lisberger/Experiments/DynamicCoherencePhysiology/data/Frederick',...
                        'chanMap',[23 1; 22 2; 21 3; 20 4; 19 5; 18 6; 17 7; 16 8; 15 9; 14 10; 13 11; 12 12; 11 13; 10 14; 9 15; 8 16; 7 17; 6 18; 5 19; 4 20; 3 21; 2 22; 1 23; 0 24],...
                        'initCohPertFile','/home/seth/Projects/DynamicCoherencePhysiology/fr/initCohPertResults/initCohPert20240208.mat',...
