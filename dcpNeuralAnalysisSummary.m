...
neuronTypingAnalysis_streamlined({'ar','fr'},...
    ...
    'saveFigures',false,'saveResults',false,'plotOpts',plotOpts)
...
modelFEF = fitReducedRankModel(subject,R,fef_t,eye_t,initGain,meanEyeSpeed,dimNames,...
    ...
    'saveResults',false,'saveFigures',false);
...
predictFiringRatesFromRRdynamics('ar','saveResults',false,'saveFigures',false)
...
predictDynCohRRdynamicsModel('ar','mirrorPositivePerturbation',true,...
    'saveFigures',false,'saveResults',false,'dynDataLoad','dcpObjects',...
    'trialCutoff',80)
